...
public class Interface_Parameters_IMHN extends javax.swing.JInternalFrame {

    
    Parameters_IMHN parameters;
    
    public Interface_Parameters_IMHN(Parameters_IMHN parameters) {
        ...
        tMaxiterationsGlobal.setText(parameters.getMaxNumberIterationsGlobal().toString());
        tMaxiterationsLocal.setText(parameters.getMaxNumberIterationsLocal().toString());
    ...
    private void initComponents() {
        ...
        tMaxiterationsGlobal = new javax.swing.JTextField();
        jLabel2 = new javax.swing.JLabel();
        tMaxiterationsLocal = new javax.swing.JTextField();
        ...
        jLabel1.setText("Máximo Global Iterations :");

        tMaxiterationsGlobal.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        tMaxiterationsGlobal.setText("100");

        jLabel2.setText("Maximo Iteracoes Local:");

        tMaxiterationsLocal.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        tMaxiterationsLocal.setText("100");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(tMaxiterationsLocal)
                    .addComponent(tMaxiterationsGlobal, javax.swing.GroupLayout.DEFAULT_SIZE, 61, Short.MAX_VALUE))
                .addContainerGap())
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(tMaxiterationsGlobal, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel1))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel2)
                    .addComponent(tMaxiterationsLocal, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void bIncluir1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bIncluir1ActionPerformed
        JOptionPane ent = new JOptionPane();
        try{
            Double item = Double.parseDouble(ent.showInputDialog(this,"Minimum mean square error:","TCT", ent.PLAIN_MESSAGE));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        parameters.setNumMaxEpocasGlobal(Integer.parseInt(tMaxiterationsGlobal.getText()));
        parameters.setNumMaxEpocasLocal(Integer.parseInt(tMaxiterationsLocal.getText()));
    ...
    private javax.swing.JTextField tMaxiterationsGlobal;
    private javax.swing.JTextField tMaxiterationsLocal;
