...
public class SupervisedInductiveConfiguration_FewLabeledExamples extends ConfigurationBase implements Serializable{
    ...
    public SupervisedInductiveConfiguration_FewLabeledExamples(){
        ...
        // Changing the values of K to make them equal to K used in transductive classification on document-networks
        ...
        this.setParametersNumLabeledInstancesPerClass(new Parameters_NumLabeledDocs());
