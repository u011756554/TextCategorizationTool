...
public class TCHN_DocTerm_TermTerm_InductiveSemiSupervised_ID extends InductiveSemiSupervisedClassifier{
    ...
    public TCHN_DocTerm_TermTerm_InductiveSemiSupervised_ID(){
        super();
    ...
    public TCHN_DocTerm_TermTerm_InductiveSemiSupervised_ID(int maxNumberGlobalIterations, int maxNumberLocalIterations, double errorCorrectionRate){
    ...
    public void buildClassifier(Instances dataTrain, Instances dataTest){
        ...
        //if(getUse() == 0){
            ...
            adjancecyListDocTerm = new Neighbor[highestInd + 1];
            adjacencyListPDocTerm = new Neighbor[highestInd + 1];

            //Inicializando as listas
            for(int inst=0;inst<(highestInd + 1);inst++){
            ...
            double[] dDoc = new double[highestInd + 1];
            for(int inst=0;inst<numTrain;inst++){
                int indInst = (int)dataTrain.instance(inst).value(0);
                double grau = 0;
        ...
        while(exit == false){
            ...
            for(int inst=0;inst<numTest;inst++){
                ...
                /*if(indInst == 1999){
                    ...
                    System.out.println("fDocsTemp size: " + fDocsTemp.length);
                    System.out.println("adjacencyListPDocTerm size: " + adjacencyListPDocTerm.length);
                    System.out.println("Highest ind:" + highestInd);
                }*/    
