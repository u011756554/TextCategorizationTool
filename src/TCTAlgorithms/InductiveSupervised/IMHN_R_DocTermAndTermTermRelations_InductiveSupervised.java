...
//              Heterogeneous Network) which induces a classification model
//              considering document-term and term-term relations. 
//*****************************************************************************
...
public class IMHN_R_DocTermAndTermTermRelations_InductiveSupervised extends InductiveSupervisedClassifier {
    ...
    // Constructor
    public IMHN_R_DocTermAndTermTermRelations_InductiveSupervised(){
        super();
    ...
    // Constructor
    public IMHN_R_DocTermAndTermTermRelations_InductiveSupervised(int maxNumberLocalIterations, int maxNumberGlobalIterations, double minError, double errorCorrectionRate, String weight){
                    ...
                    for(int classe=0;classe<numClasses;classe++){
                        for(int termo2=0;termo2<neighbors.size();termo2++){
                            try{
                                ...
                                double newWeight = fTerms[termo1][classe] + (errorCorrectionRate *  neighbors.get(termo2).value * neighbors.get(termo2).value * error);
                                fTerms[termo1][classe] = newWeight;
                            }catch(Exception e){}
                        }
                    }
                }
    ...
    public double classifyInstance(Instance instance){
        ...
        //Labeling a document according to the highest class information value
