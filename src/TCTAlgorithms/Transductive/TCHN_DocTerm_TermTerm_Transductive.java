...
public class TCHN_DocTerm_TermTerm_Transductive extends TransductiveLearner {
    ...
    public TCHN_DocTerm_TermTerm_Transductive(){
        super();
    ...
    public TCHN_DocTerm_TermTerm_Transductive(int maxNumberGlobalIterations, int maxNumberLocalIterations, double errorCorrectionRate){
