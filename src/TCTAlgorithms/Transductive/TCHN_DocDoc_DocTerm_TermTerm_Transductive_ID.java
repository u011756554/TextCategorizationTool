...
public class TCHN_DocDoc_DocTerm_TermTerm_Transductive_ID extends TransductiveLearner {
    ...
    private double[][] matSim; // matrox to store relation weights among documents
    
    // Constructor
    public TCHN_DocDoc_DocTerm_TermTerm_Transductive_ID(){
        super();
    ...
    // Constructor
    public TCHN_DocDoc_DocTerm_TermTerm_Transductive_ID(int maxNumberGlobalIterations, int maxNumberLocalIterations, double errorCorrectionRate){
